  ...
  return (
    <div className="shadow-3xl bg-white h-[300px] rounded-3xl overflow-hidden max-w-md w-full">
      ...
      <div className="h-full flex flex-row justify-between">
        ...
        <div className="w-[50%] rounded-4xl relative h-full">
          <Image
            src={packages.image}
        ...
        <div className="w-[50%] p-6 text-black space-y-1">
          ...
          {/* Button */}
          <Button onClick={()=> { handleClick()}} className="hover:cursor-pointer rounded-full bg-primary text-white font-normal py-2 transition-colors">
            Add to Cart
          </Button>
        </div>
      </div>
