...
const HowItWorks = () => {
  return (
    <div className="w-full max-h-[400px] mt-18 lg:mt-0 max-w-7xl mx-auto py-24 flex justify-center lg:justify-start items-center">
      <div className="w-full">
        <h1 className="text-4xl lg:text-start text-center text-primary ">
          Register and pay in under 3 minutes
        </h1>
        <p className="text-black font-normal text-center px-2 lg:px-0 lg:text-start ">
