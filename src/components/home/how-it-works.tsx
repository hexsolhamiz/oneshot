...
const HowItWorks = () => {
  return (
    <div className="w-full max-h-[400px] max-w-7xl mx-auto py-24 flex items-center justify-center lg:justify-start items-center">
            ...
            howLinks.map((link)=> {
                return (
                    <div key={link.id} className="flex items-center shadow-md px-14 rounded-xl py-6">
                        ...
                        <span className="text-black font-bold">{link.text}</span>
                    </div>
                );
            })
            }
