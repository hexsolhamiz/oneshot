        ...
        <CarouselContent className="w-full">
          {stories.map((story, index) => (
            <CarouselItem key={index} className="">
              <div className="p-1">
                <Card className="w-full min-h-[300px] shadow-2xl border-r border-b border-b-primary border-r-primary">
                  <CardContent className="w-full flex gap-4 flex-col items-center justify-center p-6">
                    ...
                    <h1 className="text-primary text-2xl">{story.name}</h1>
                     <p className="lg:max-w-xs text-center">{story.description}</p>
