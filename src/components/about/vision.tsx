...
export const Vision = () => {
  return (
    <div className="min-h-[350px] my-12 max-w-7xl rounded-4xl mx-auto border-2 border-l-primary border-b-primary border-t-primary w-full flex lg:flex-row flex-col px-4 lg:px-0">
