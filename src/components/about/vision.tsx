...
export const Vision = () => {
  return (
    <div className="min-h-[350px] my-12 max-w-7xl rounded-4xl mx-auto border-2 border-l-primary border-b-primary border-t-primary w-full flex lg:flex-row flex-col px-1 lg:px-0">
      <div className="relative  lg:w-[35%] w-full">
        <Image src="/about/vision.png" alt="Mission" fill className="" />
      </div>
      <div className="lg:w-[65%] lg:px-12 px-4 py-6 w-full flex flex-col justify-center">
        <h1 className="text-4xl text-primary text-start">OUR VISION</h1>
