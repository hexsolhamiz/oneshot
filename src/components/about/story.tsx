      ...
      <Card className="w-full h-full shadow-none border-none">
        <CardContent className="p-0 w-full flex">
          <div className="flex w-full">
            ...
            {/* Center Content */}
            <div className="w-full h-full text-center flex flex-col justify-center lg:w-[50%] px-2 lg:px-4">
              <h1 className="text-4xl text-primary text-center">Story of one Shot</h1>
